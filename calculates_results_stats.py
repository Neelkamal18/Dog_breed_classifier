...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            ...
            # Classifier correctly classifies image as Dog
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1

        # Count correctly classified NOT-a-dog images
        else:
            # Classifier correctly classifies image as NOT a Dog
    ...
    # Calculate % of correctly classified dog images
    ...
    # Calculate % of correctly classified breeds of dogs
    if results_stats_dic['n_dogs_img'] > 0:
    ...
    # Calculate % of correctly classified NOT-a-dog images
    ...
    # TODO 5f. Return the results_stats_dic dictionary
